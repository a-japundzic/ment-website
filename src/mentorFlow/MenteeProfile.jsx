            ...
            <div className="col-md-4">
                <div className="card mt-2 w-100" >
                    ...
                    <div className="card-body">
                        ...
                        { (state?.mentee?.linkedin !== "" || state?.mentee?.instagram !== "" || state?.mentee?.linkedin !== "") && (
                            <div className="row mt-3">
                            <h6 className="tw-font-semibold tw-font-dmsans">Socials</h6>
                            </div>
                        )}
                        <div className="row align-items-center">
                            { state?.mentee?.instagram !== null && state?.mentee?.instagram !== "" && (
                            <div className="col-2">
                            ...
                            { state?.mentee?.facebook !== null && state?.mentee?.facebook !== "" && (
                            <div className="col-2">
                            ...
                            { state?.mentee?.linkedin !== null && state?.mentee?.linkedin !== "" && (
                            <div className="col-2">
            ...
            <div className="col mt-2">
                ...
                <div>
                    ...
                    <ul className="list-group list-group-horizontal-md tw-font-dmsans">
                        {state?.mentee?.values.map((value, index) => {
                            if (value !== "") {
