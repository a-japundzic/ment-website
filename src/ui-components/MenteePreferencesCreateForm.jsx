...
import { createMenteePreferences } from "../graphql/mutations";
...
export default function MenteePreferencesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMentorshipSkills(initialValues.mentorshipSkills);
    setCurrentMentorshipSkillsValue("");
    setMentorshipType(initialValues.mentorshipType);
    setCurrentMentorshipTypeValue("");
    setMentorshipFrequency(initialValues.mentorshipFrequency);
    setCurrentMentorshipFrequencyValue("");
    setMentorshipGoal(initialValues.mentorshipGoal);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMenteePreferences.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MenteePreferencesCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner"
